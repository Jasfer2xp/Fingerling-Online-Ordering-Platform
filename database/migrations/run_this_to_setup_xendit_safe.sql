-- =====================================================
-- SAFE SETUP SCRIPT FOR XENDIT & NOTIFICATIONS
...
-- =====================================================
-- PART 2: NOTIFICATIONS TABLE UPDATES (SAFE VERSION)
-- =====================================================
...
SET @sql = IF(@col_exists = 0, 
    ...
    'SELECT "Column customer_id already exists, skipping" AS message'
);
...
SET @sql = IF(@col_exists = 0, 
    ...
    'SELECT "Column link already exists, skipping" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0, 
    ...
    'SELECT "Index idx_customer_id already exists, skipping" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
