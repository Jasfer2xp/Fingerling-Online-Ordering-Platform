        ...
        switch ($action) {
            case 'submit_feedback':
                ...
                $sql = "INSERT INTO feedback (order_id, customer_id, supplier_id, rating, comment, image_path, created_at) 
                        VALUES (?, ?, ?, ?, ?, ?, NOW())";
                $database->query($sql, [$order_id, $customer_id, $order_details['supplier_id'], $rating, $review_text, $image_path]);
                ...
                $total_ratings = $rating_data['total_ratings'] ? intval($rating_data['total_ratings']) : 0;
...
$page_title = 'Rate Supplier - Order #' . $order_details['order_number'];
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="mb-0">Order #<?php echo htmlspecialchars($order_details['order_number']); ?></h5>
                </div>
                <div class="card-body">
                    <form method="POST" id="feedback-form" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <h6 class="mb-3">Supplier: <?php echo htmlspecialchars($order_details['business_name']); ?></h6>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="review_text" name="review_text" rows="4" placeholder="Share your experience with this supplier..."></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Upload an image as evidence of the supplier's behavior or delivery process (JPG, PNG, GIF)</div>
                            </div>
