...
$permit_path = !empty($supplier['valid_id']) ? $supplier['valid_id'] : null;
$permit_filename = $permit_path ? basename($permit_path) : null;
$permit_url = $permit_path ? base_url($permit_path) : null;
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if ($permit_url && file_exists($_SERVER['DOCUMENT_ROOT'] . parse_url($permit_url, PHP_URL_PATH))): ?>
                                        <?php 
                                        ...
                                        <div class="border rounded p-3 bg-light">
                                            <?php if (in_array($extension, ['jpg', 'jpeg', 'png'])): ?>
                                                <div class="mb-2">
                                                    <a href="<?php echo $permit_url; ?>" target="_blank">
                                                        <img src="<?php echo $permit_url; ?>" alt="Valid ID" 
                                                             class="img-fluid rounded" style="max-height: 150px;">
                                                    </a>
                                                </div>
                                            <?php elseif ($extension === 'pdf'): ?>
                                                <div class="mb-2">
                                                    <a href="<?php echo $permit_url; ?>" target="_blank" class="btn btn-outline-danger btn-sm">
                                                        View PDF
                                                    </a>
                                                </div>
                                            <?php else: ?>
                                                <div class="mb-2">
                                                    <a href="<?php echo $permit_url; ?>" target="_blank" class="btn btn-outline-secondary btn-sm">
                                                        View File
                                                    </a>
                                                </div>
                                            <?php endif; ?>
                                            <a href="<?php echo $permit_url; ?>" 
