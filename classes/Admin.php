    ...
    public function deleteFeedback($feedback_id) {
        ...
        try {
            ...
            if (!empty($feedback['image_path'])) {
                ...
                $possible_paths = [
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . 'customer/' . ltrim($feedback['image_path'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . ltrim($feedback['image_path'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/' . ltrim($feedback['image_path'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/feedback/' . ltrim($feedback['image_path'], '/')
                ];
        ...
        try {
            ...
            foreach ($inventory_items as $item) {
                if (!empty($item['image_path'])) {
                    $image_paths = [
                        $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . ltrim($item['image_path'], '/'),
                        $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/products/' . basename($item['image_path']),
                        __DIR__ . '/../uploads/products/' . basename($item['image_path'])
                    ];
            ...
            if (!empty($supplier['valid_id'])) {
                $permit_paths = [
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . ltrim($supplier['valid_id'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/permits/' . basename($supplier['valid_id']),
                    __DIR__ . '/../uploads/permits/' . basename($supplier['valid_id'])
                ];
            ...
            if (!empty($supplier['logo_url'])) {
                $logo_paths = [
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . ltrim($supplier['logo_url'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/logos/' . basename($supplier['logo_url']),
                    __DIR__ . '/../uploads/logos/' . basename($supplier['logo_url'])
                ];
            ...
            if (!empty($supplier['pond_photo'])) {
                $pond_paths = [
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/' . ltrim($supplier['pond_photo'], '/'),
                    $_SERVER['DOCUMENT_ROOT'] . '/capstone/uploads/' . basename($supplier['pond_photo']),
                    __DIR__ . '/../uploads/' . basename($supplier['pond_photo'])
                ];
