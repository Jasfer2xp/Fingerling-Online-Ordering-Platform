...
$url = $endpoint . '/v2/payments/authorizations/' . urlencode($authorization_id) . '/void';
...
if ($curlError) {
    error_log("PayPal Void Authorization cURL Error: $curlError");
...
if ($httpCode !== 204 && $httpCode !== 200) {
    ...
    error_log("PayPal Void Authorization Failed: " . json_encode($result));
    http_response_code(400);
    exit(json_encode(['success' => false, 'message' => 'Payment void failed: ' . $msg]));
}
