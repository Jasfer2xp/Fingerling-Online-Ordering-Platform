 ...
 echo APP_NAME; ?></h5>
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo base_url('customer/dashboard.php'); ?>">Browse</a></li>
                        <li><a href="<?php echo base_url('customer/suppliers.php'); ?>">Suppliers</a></li>
                        <li><a href="<?php echo base_url('customer/help.php'); ?>">Help</a></li>
                        <li><a href="<?php echo base_url('customer/contact.php'); ?>">Contact</a></li>
                    </ul>
                </div>
